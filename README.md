...
- **Automatic Lung nodule segmentation and classification in CT images based on SVM**  
  Authors: Rendon-Gonzalez, Elmar and Ponomaryov, Volodymyr  
  [[Paper]]()
- **Improved techniques for training gans**  
  Authors: Salimans, Tim and Goodfellow, Ian and Zaremba, Wojciech and Cheung, Vicki and Radford, Alec and Chen, Xi  
  [[Paper]]()
- **Object tracking by color and active contour models segmentation**  
  Authors: Silva, A Santos and Severgnini, F Marcolino Quintao and Oliveira, M Lopes and Mendes, V Matheus Santiago and Peixoto, ZM Assis  
  [[Paper]]()
- **Active contour energy used in object recognition method**  
  Authors: Zhou, Zhiheng and Liu, Kaiyi and Ou, Xiaowen  
  [[Paper]]()
...
- **Dynamically balanced online random forests for interactive scribble-based segmentation**  
  Authors: Wang, Guotai and Zuluaga, Maria A and Pratt, Rosalind and Aertsen, Michael and Doel, Tom and Klusmann, Maria and David, Anna L and Deprest, Jan and Vercauteren, Tom and Ourselin, S{\'e  
  [[Paper]]()
...
- **A parameterized logarithmic image processing method with Laplacian of Gaussian filtering for lung nodule enhancement in chest radiographs**  
  Authors: Chen, Sheng and Yao, Liping and Chen, Bao  
  [[Paper]]()
...
- **Prediction of lung cancer incidence on the low-dose computed tomography arm of the National Lung Screening Trial: A dynamic Bayesian network**  
  Authors: Petousis, Panayiotis and Han, Simon X and Aberle, Denise and Bui, Alex AT  
  [[Paper]]()
- **Automated detection of pulmonary nodules in PET/CT images: Ensemble false-positive reduction using a convolutional neural network technique**  
  Authors: Teramoto, Atsushi and Fujita, Hiroshi and Yamamuro, Osamu and Tamaki, Tsuneo  
  [[Paper]]()
- **Recurrent convolutional networks for pulmonary nodule detection in CT imaging**  
  Authors: Ypsilantis, Petros-Pavlos and Montana, Giovanni  
  [[Paper]]()
- **A novel approach to CAD system for the detection of lung nodules in CT images**  
  Authors: Javaid, Muzzamil and Javid, Moazzam and Rehman, Muhammad Zia Ur and Shah, Syed Irtiza Ali  
  [[Paper]]()
- **An automated lung nodule detection system for CT images using synthetic minority oversampling**  
  Authors: Mehre, Shrikant A and Mukhopadhyay, Sudipta and Dutta, Anirvan and Harsha, Nagam Chaithan and Dhara, Ashis Kumar and Khandelwal, Niranjan  
  [[Paper]]()
- **Pulmonary nodules detection and classification using hybrid features from computerized tomographic images**  
  Authors: Akram, Sheeraz and Javed, Muhammad Younus and Akram, M Usman and Qamar, Usman and Hassan, Ali  
  [[Paper]]()
- **Toward a shared vision for cancer genomic data**  
  Authors: Grossman, Robert L and Heath, Allison P and Ferretti, Vincent and Varmus, Harold E and Lowy, Douglas R and Kibbe, Warren A and Staudt, Louis M  
  [[Paper]]()
- **ATLAAS: an automatic decision tree-based learning algorithm for advanced image segmentation in positron emission tomography**  
  Authors: Berthon, Beatrice and Marshall, Christopher and Evans, Mererid and Spezi, Emiliano  
  [[Paper]]()
- **V-net: Fully convolutional neural networks for volumetric medical image segmentation**  
  Authors: Milletari, Fausto and Navab, Nassir and Ahmadi, Seyed-Ahmad and others  
  [[Paper]]()
- **Computer-aided detection of pulmonary nodules using dynamic self-adaptive template matching and a FLDA classifier**  
  Authors: Gong, Jing and Liu, Ji-yu and Wang, Li-jia and Zheng, Bin and Nie, Sheng-dong  
  [[Paper]]()

### *2015*
- **Fully convolutional networks for semantic segmentation**  
  Authors: Long, Jonathan and Shelhamer, Evan and Darrell, Trevor  
  [[Paper]]()
- **U-net: Convolutional networks for biomedical image segmentation**  
  Authors: Ronneberger, Olaf and Fischer, Philipp and Brox, Thomas  
  [[Paper]]()
- **Siamese neural networks for one-shot image recognition**  
  Authors: Koch, Gregory and Zemel, Richard and Salakhutdinov, Ruslan and others  
  [[Paper]]()
- **Unsupervised learning of video representations using lstms**  
  Authors: Srivastava, Nitish and Mansimov, Elman and Salakhudinov, Ruslan  
  [[Paper]]()
- **Adversarial autoencoders**  
  Authors: Makhzani, Alireza and Shlens, Jonathon and Jaitly, Navdeep and Goodfellow, Ian and Frey, Brendan  
  [[Paper]]()
- **Multi-scale context aggregation by dilated convolutions**  
  Authors: Yu, Fisher and Koltun, Vladlen  
  [[Paper]]()
- **CRF learning with CNN features for image segmentation**  
  Authors: Liu, Fayao and Lin, Guosheng and Shen, Chunhua  
  [[Paper]]()
- **Unsupervised representation learning with deep convolutional generative adversarial networks**  
  Authors: Radford, Alec and Metz, Luke and Chintala, Soumith  
  [[Paper]]()
- **IoTs enable active contour modeling based energy efficient and thermal aware object tracking on FPGA**  
  Authors: Musavi, Sayed Hyder Abbas and Chowdhry, BS and Kumar, Tanesh and Pandey, Bishwajeet and Kumar, Wanod  
  [[Paper]]()
- **A contour tracking method of large motion object using optical flow and active contour model**  
  Authors: Choi, Jin Woo and Whangbo, Taeg Keun and Kim, Cheong Ghil  
  [[Paper]]()
- **An automated lung parenchyma segmentation method for 3D thoracic MR images**  
  Authors: Li, Y and Chen, H and Wei, X  
  [[Paper]]()
- **A novel approach of lung segmentation on chest CT images using graph cuts**  
  Authors: Dai, Shuangfeng and Lu, Ke and Dong, Jiyang and Zhang, Yifei and Chen, Yong  
  [[Paper]]()
- **PET image segmentation using a Gaussian mixture model and Markov random fields**  
  Authors: Layer, Thomas and Blaickner, Matthias and Kn{\"a  
  [[Paper]]()
- **Benign and malignant breast tumors classification based on region growing and CNN segmentation**  
  Authors: Rouhi, Rahimeh and Jafari, Mehdi and Kasaei, Shohreh and Keshavarzian, Peiman  
  [[Paper]]()
- **Lung lesion extraction using a toboggan based growing automatic segmentation approach**  
  Authors: Song, Jiangdian and Yang, Caiyun and Fan, Li and Wang, Kun and Yang, Feng and Liu, Shiyuan and Tian, Jie  
  [[Paper]]()
- **Random walk and graph cut for co-segmentation of lung tumor on PET-CT images**  
  Authors: Ju, Wei and Xiang, Deihui and Zhang, Bin and Wang, Lirong and Kopriva, Ivica and Chen, Xinjian  
  [[Paper]]()
- **An approach toward fast gradient-based image segmentation**  
  Authors: Hell, Benjamin and Kassubeck, Marc and Bauszat, Pablo and Eisemann, Martin and Magnor, Marcus  
  [[Paper]]()
- **An improved edge detection using morphological Laplacian of Gaussian operator**  
  Authors: Anand, Ashish and Tripathy, Sanjaya Shankar and Kumar, R Sukesh  
  [[Paper]]()
- **Recurrent convolutional neural network for object recognition**  
  Authors: Liang, Ming and Hu, Xiaolin  
  [[Paper]]()
- **Recurrent convolutional neural networks for text classification**  
  Authors: Lai, Siwei and Xu, Liheng and Liu, Kang and Zhao, Jun  
  [[Paper]]()
- **A robust approach for automated lung segmentation in thoracic CT**  
  Authors: Zhou, Hailing and Goldgof, Dmitry B and Hawkins, Samuel and Wei, Lei and Liu, Ying and Creighton, Doug and Gillies, Robert J and Hall, Lawrence O and Nahavandi, Saeid  
  [[Paper]]()
- **Segmentation of pulmonary nodules in computed tomography using a regression neural network approach and its application to the lung image database consortium and image database resource initiative dataset**  
  Authors: Messay, Temesguen and Hardie, Russell C and Tuinstra, Timothy R  
  [[Paper]]()
...
- **A Survey On Fuzzy Clustering Techniques For Lung CT Image Segmentation**  
  Authors: Vijila, C Kezi Selva and Tharcis, P  
  [[Paper]]()
- **An automated lung segmentation approach using bidirectional chain codes to improve nodule detection accuracy**  
  Authors: Shen, Shiwen and Bui, Alex AT and Cong, Jason and Hsu, William  
  [[Paper]]()
- **Segmentation of CT lung nodules using FCM with firefly search algorithm**  
  Authors: Shaik Parveen, S. and Kavitha, C.  
  [[Paper]]()
...
- **Conditional generative adversarial nets**  
  Authors: Mirza, Mehdi and Osindero, Simon  
  [[Paper]]()
...
- **Automatic detection of small lung nodules in 3D CT data using Gaussian mixture models, Tsallis entropy and SVM**  
  Authors: Santos, Alex Martins and de Carvalho Filho, Antonio Oseas and Silva, Arist{\'o  
  [[Paper]]()
- **Refinement of lung nodule candidates based on local geometric shape analysis and Laplacian of Gaussian kernels**  
  Authors: Saien, Soudeh and Pilevar, Abdol Hamid and Moghaddam, Hamid Abrishami  
  [[Paper]]()
- **A survey on threshold based segmentation technique in image processing**  
  Authors: Bhargavi, K and Jyothi, S  
  [[Paper]]()
- **An application of oversampling, undersampling, bagging and boosting in handling imbalanced datasets**  
  Authors: Yap, Bee Wah and Rani, Khatijahhusna Abd and Rahman, Hezlin Aryani Abd and Fong, Simon and Khairudin, Zuraida and Abdullah, Nik Nik  
  [[Paper]]()
- **National Lung Screening Trial Research Team. Results of the Two Incidence Screenings in the National Lung Screening Trial**  
  Authors: Hwang, Jennifer Y and Arredondo, Anthony F and Paul, Tessy K  
  [[Paper]]()
- **Decoding tumour phenotype by noninvasive imaging using a quantitative radiomics approach**  
  Authors: Aerts, Hugo JWL and Velazquez, Emmanuel Rios and Leijenaar, Ralph TH and Parmar, Chintan and Grossmann, Patrick and Carvalho, Sara and Bussink, Johan and Monshouwer, Ren{\'e  
  [[Paper]]()
- **Recurrent convolutional neural networks for scene labeling**  
  Authors: Pinheiro, Pedro and Collobert, Ronan  
  [[Paper]]()
- **Hidden conditional random field for lung nodule detection**  
  Authors: Liu, Yang and Wang, Zhongqiu and Guo, Maozu and Li, Ping  
  [[Paper]]()
- **Fast and adaptive detection of pulmonary nodules in thoracic CT images using a hierarchical vector quantization scheme**  
  Authors: Han, Hao and Li, Lihong and Han, Fangfang and Song, Bowen and Moore, William and Liang, Zhengrong  
  [[Paper]]()
- **A comprehensive framework for automatic detection of pulmonary nodules in lung CT images**  
  Authors: Alilou, Mehdi and Kovalev, Vassili and Snezhko, Eduard and Taimouri, Vahid  
  [[Paper]]()
- **Automatic detection of solitary lung nodules using quality threshold clustering, genetic algorithm and diversity index**  
  Authors: de Carvalho Filho, Antonio Oseas and de Sampaio, Wener Borges and Silva, Aristofanes Correa and de Paiva, Anselmo Cardoso and Nunes, Rodolfo Acatauassu and Gattass, Marcelo  
  [[Paper]]()
...
- **Robust selection-based sparse shape model for lung cancer image segmentation**  
  Authors: Xing, Fuyong and Yang, Lin  
  [[Paper]]()
- **Hybrid segmentation of left ventricle in cardiac MRI using gaussian-mixture model and region restricted dynamic programming**  
  Authors: Hu, Huaifei and Liu, Haihua and Gao, Zhiyong and Huang, Lu  
  [[Paper]]()
- **Multi-shape graph cuts with neighbor prior constraints and its application to lung segmentation from a chest CT volume**  
  Authors: Nakagomi, Keita and Shimizu, Akinobu and Kobatake, Hidefumi and Yakami, Masahiro and Fujimoto, Koji and Togashi, Kaori  
  [[Paper]]()
- **Classification of the lung diseases from ct scans by advanced segmentation techniques using genetic algorithm**  
  Authors: Bhuvaneswari, C and Aruna, P and Loganathan, D  
  [[Paper]]()
- **Decision trees: a recent overview**  
  Authors: Kotsiantis, Sotiris B  
  [[Paper]]()
- **Automatic segmentation of lung carcinoma using 3D texture features in 18-FDG PET/CT**  
  Authors: Markel, Daniel and Caldwell, Curtis and Alasti, Hamideh and Soliman, Hany and Ung, Yee and Lee, Justin and Sun, Alexander  
  [[Paper]]()
- **Lung segmentation in chest radiographs using anatomical atlases with nonrigid registration**  
  Authors: Candemir, Sema and Jaeger, Stefan and Palaniappan, Kannappan and Musco, Jonathan P and Singh, Rahul K and Xue, Zhiyun and Karargyris, Alexandros and Antani, Sameer and Thoma, George and McDonald, Clement J  
  [[Paper]]()

### *2012*
- **A novel content-based active contour model for brain tumor segmentation**  
  Authors: Sachdeva, Jainy and Kumar, Vinod and Gupta, Indra and Khandelwal, Niranjan and Ahuja, Chirag Kamal  
  [[Paper]]()
- **Small object detection in cluttered image using a correlation based active contour model**  
  Authors: Vard, Alireza and Jamshidi, Kamal and Movahhedinia, Naser  
  [[Paper]]()
- **Online random forest for interactive image segmentation**  
  Authors: Barinova, Olga and Shapovalov, Roman and Sudakov, Sergey and Velizhev, Alexander  
  [[Paper]]()
- **A comparison of various edge detection techniques used in image processing**  
  Authors: Shrivakshan, GT and Chandrasekar, Chandramouli  
  [[Paper]]()
- **Automatic segmentation of lung nodules with growing neural gas and support vector machine**  
  Authors: Netto, Stelmo Magalh{\~a  
  [[Paper]]()
- **Automated feature weighting in naive bayes for high-dimensional data classification**  
  Authors: Chen, Lifei and Wang, Shengrui  
  [[Paper]]()
- **Lungs segmentation using multi-level thresholding in CT images**  
  Authors: Karthikeyan, A and Valliammai, M  
  [[Paper]]()

### *2011*
- **Contractive auto-encoders: Explicit invariance during feature extraction**  
  Authors: Salah, Rifai and Vincent, P and Muller, X and others  
  [[Paper]]()
- **Stacked convolutional auto-encoders for hierarchical feature extraction**  
  Authors: Masci, Jonathan and Meier, Ueli and Cire{\c{s  
  [[Paper]]()
- **Interactive segmentation of lung nodules using AdaBoost and Graph Cuts**  
  Authors: Li, Yuanzhong and Ito, Wataru and Iwano, Shingo  
  [[Paper]]()
- **The lung image database consortium (LIDC) and image database resource initiative (IDRI): a completed reference database of lung nodules on CT scans**  
  Authors: Armato III, Samuel G and McLennan, Geoffrey and Bidaut, Luc and McNitt-Gray, Michael F and Meyer, Charles R and Reeves, Anthony P and Zhao, Binsheng and Aberle, Denise R and Henschke, Claudia I and Hoffman, Eric A and others  
  [[Paper]]()

### *2010*
- **A computer aided diagnosis system for lung cancer detection using support vector machine**  
  Authors: Gomathi, M and Thangaraj, P  
  [[Paper]]()
- **Comparing and combining algorithms for computer-aided detection of pulmonary nodules in computed tomography scans: the ANODE09 study**  
  Authors: Van Ginneken, Bram and Armato III, Samuel G and de Hoop, Bartjan and van Amelsvoort-van de Vorst, Saskia and Duindam, Thomas and Niemeijer, Meindert and Murphy, Keelin and Schilham, Arnold and Retico, Alessandra and Fantacci, Maria Evelina and others  
  [[Paper]]()

### *2009*
- **An active contour model for segmenting and measuring retinal vessels**  
  Authors: Al-Diri, Bashir and Hunter, Andrew and Steel, David  
  [[Paper]]()
- **On-line random forests**  
  Authors: Saffari, Amir and Leistner, Christian and Santner, Jakob and Godec, Martin and Bischof, Horst  
  [[Paper]]()
- **Interactive Texture Segmentation using Random Forests and Total Variation.**  
  Authors: Santner, Jakob and Unger, Markus and Pock, Thomas and Leistner, Christian and Saffari, Amir and Bischof, Horst  
  [[Paper]]()
- **Evaluating variability in tumor measurements from same-day repeat CT scans of patients with non--small cell lung cancer**  
  Authors: Zhao, Binsheng and James, Leonard P and Moskowitz, Chaya S and Guo, Pingzhen and Ginsberg, Michelle S and Lefkowitz, Robert A and Qin, Yilin and Riely, Gregory J and Kris, Mark G and Schwartz, Lawrence H  
  [[Paper]]()

### *2008*
- **Extracting and composing robust features with denoising autoencoders**  
  Authors: Vincent, Pascal and Larochelle, Hugo and Bengio, Yoshua and Manzagol, Pierre-Antoine  
  [[Paper]]()

### *2007*
- **Accurate lung segmentation for X-ray CT images**  
  Authors: Gao, Qixin and Wang, ShengJun and Zhao, Dazhe and Liu, Jiren  
  [[Paper]]()

### *2006*
- **Efficient learning of sparse representations with an energy-based model**  
  Authors: Ranzato, Marc'Aurelio and Poultney, Christopher and Chopra, Sumit and Cun, Yann  
  [[Paper]]()

### *2004*
- **Application of active contour models in medical image segmentation**  
  Authors: Derraz, Foued and Beladgham, Mohamed and Khelif, M’hamed  
  [[Paper]]()

### *2002*
- **The recognition and analysis of animate objects using neural networks and active contour models**  
  Authors: Tabb, Ken and Davey, Neil and Adams, Rod and George, Stella  
  [[Paper]]()
...
- **Development of a digital image database for chest radiographs with and without a lung nodule: receiver operating characteristic analysis of radiologists' detection of pulmonary nodules**  
  Authors: Shiraishi, Junji and Katsuragawa, Shigehiko and Ikezoe, Junpei and Matsumoto, Tsuneo and Kobayashi, Takeshi and Komatsu, Ken-ichi and Matsui, Mitate and Fujita, Hiroshi and Kodera, Yoshie and Doi, Kunio  
  [[Paper]]()

### *1993*
- **A geometric model for active contours in image processing**  
  Authors: Caselles, Vicent and Catt{\'e  
  [[Paper]]()

### *1988*
- **Snakes: Active contour models**  
  Authors: Kass, Michael and Witkin, Andrew and Terzopoulos, Demetri  
  [[Paper]]()
